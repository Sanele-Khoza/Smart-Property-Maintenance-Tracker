...
declare const BatchDetectDominantLanguageCommand_base: {
    new (input: BatchDetectDominantLanguageCommandInput): import("@smithy/core/client").CommandImpl<BatchDetectDominantLanguageCommandInput, BatchDetectDominantLanguageCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDetectDominantLanguageCommandInput): import("@smithy/core/client").CommandImpl<BatchDetectDominantLanguageCommandInput, BatchDetectDominantLanguageCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
