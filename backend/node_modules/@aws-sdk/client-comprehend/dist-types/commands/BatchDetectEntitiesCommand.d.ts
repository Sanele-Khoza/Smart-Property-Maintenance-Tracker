...
declare const BatchDetectEntitiesCommand_base: {
    new (input: BatchDetectEntitiesCommandInput): import("@smithy/core/client").CommandImpl<BatchDetectEntitiesCommandInput, BatchDetectEntitiesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDetectEntitiesCommandInput): import("@smithy/core/client").CommandImpl<BatchDetectEntitiesCommandInput, BatchDetectEntitiesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
