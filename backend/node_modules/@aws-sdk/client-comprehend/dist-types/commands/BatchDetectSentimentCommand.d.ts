...
import type { BatchDetectSentimentRequest, BatchDetectSentimentResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const BatchDetectSentimentCommand_base: {
    new (input: BatchDetectSentimentCommandInput): import("@smithy/core/client").CommandImpl<BatchDetectSentimentCommandInput, BatchDetectSentimentCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDetectSentimentCommandInput): import("@smithy/core/client").CommandImpl<BatchDetectSentimentCommandInput, BatchDetectSentimentCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
