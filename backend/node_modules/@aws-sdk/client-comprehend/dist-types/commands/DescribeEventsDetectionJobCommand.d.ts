...
import type { DescribeEventsDetectionJobRequest, DescribeEventsDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeEventsDetectionJobCommand_base: {
    new (input: DescribeEventsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeEventsDetectionJobCommandInput, DescribeEventsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEventsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeEventsDetectionJobCommandInput, DescribeEventsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
