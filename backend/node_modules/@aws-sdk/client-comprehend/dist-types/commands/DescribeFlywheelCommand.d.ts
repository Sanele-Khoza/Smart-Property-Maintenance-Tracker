...
declare const DescribeFlywheelCommand_base: {
    new (input: DescribeFlywheelCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlywheelCommandInput, DescribeFlywheelCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFlywheelCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlywheelCommandInput, DescribeFlywheelCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
