...
declare const DescribeFlywheelIterationCommand_base: {
    new (input: DescribeFlywheelIterationCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlywheelIterationCommandInput, DescribeFlywheelIterationCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFlywheelIterationCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlywheelIterationCommandInput, DescribeFlywheelIterationCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
