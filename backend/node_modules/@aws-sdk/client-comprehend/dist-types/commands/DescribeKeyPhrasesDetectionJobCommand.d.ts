...
declare const DescribeKeyPhrasesDetectionJobCommand_base: {
    new (input: DescribeKeyPhrasesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyPhrasesDetectionJobCommandInput, DescribeKeyPhrasesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeKeyPhrasesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyPhrasesDetectionJobCommandInput, DescribeKeyPhrasesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
