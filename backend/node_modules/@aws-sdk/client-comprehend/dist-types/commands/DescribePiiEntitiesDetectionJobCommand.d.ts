...
import type { DescribePiiEntitiesDetectionJobRequest, DescribePiiEntitiesDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribePiiEntitiesDetectionJobCommand_base: {
    new (input: DescribePiiEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribePiiEntitiesDetectionJobCommandInput, DescribePiiEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribePiiEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribePiiEntitiesDetectionJobCommandInput, DescribePiiEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
