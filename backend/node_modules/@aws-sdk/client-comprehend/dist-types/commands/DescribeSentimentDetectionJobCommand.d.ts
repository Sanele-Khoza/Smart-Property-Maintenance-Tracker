...
declare const DescribeSentimentDetectionJobCommand_base: {
    new (input: DescribeSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeSentimentDetectionJobCommandInput, DescribeSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeSentimentDetectionJobCommandInput, DescribeSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
