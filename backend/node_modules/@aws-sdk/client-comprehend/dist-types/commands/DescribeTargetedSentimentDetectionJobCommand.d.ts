...
import type { DescribeTargetedSentimentDetectionJobRequest, DescribeTargetedSentimentDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeTargetedSentimentDetectionJobCommand_base: {
    new (input: DescribeTargetedSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTargetedSentimentDetectionJobCommandInput, DescribeTargetedSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTargetedSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTargetedSentimentDetectionJobCommandInput, DescribeTargetedSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
