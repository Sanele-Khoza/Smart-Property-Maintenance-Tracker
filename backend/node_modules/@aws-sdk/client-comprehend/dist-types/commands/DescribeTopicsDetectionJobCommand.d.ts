...
import type { DescribeTopicsDetectionJobRequest, DescribeTopicsDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeTopicsDetectionJobCommand_base: {
    new (input: DescribeTopicsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTopicsDetectionJobCommandInput, DescribeTopicsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTopicsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeTopicsDetectionJobCommandInput, DescribeTopicsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
