...
import type { DetectDominantLanguageRequest, DetectDominantLanguageResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DetectDominantLanguageCommand_base: {
    new (input: DetectDominantLanguageCommandInput): import("@smithy/core/client").CommandImpl<DetectDominantLanguageCommandInput, DetectDominantLanguageCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectDominantLanguageCommandInput): import("@smithy/core/client").CommandImpl<DetectDominantLanguageCommandInput, DetectDominantLanguageCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
