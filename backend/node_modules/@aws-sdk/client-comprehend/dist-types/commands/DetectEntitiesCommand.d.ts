...
declare const DetectEntitiesCommand_base: {
    new (input: DetectEntitiesCommandInput): import("@smithy/core/client").CommandImpl<DetectEntitiesCommandInput, DetectEntitiesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DetectEntitiesCommandInput]): import("@smithy/core/client").CommandImpl<DetectEntitiesCommandInput, DetectEntitiesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
