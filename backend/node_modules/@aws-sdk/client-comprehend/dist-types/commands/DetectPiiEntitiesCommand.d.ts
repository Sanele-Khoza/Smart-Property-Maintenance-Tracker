...
declare const DetectPiiEntitiesCommand_base: {
    new (input: DetectPiiEntitiesCommandInput): import("@smithy/core/client").CommandImpl<DetectPiiEntitiesCommandInput, DetectPiiEntitiesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectPiiEntitiesCommandInput): import("@smithy/core/client").CommandImpl<DetectPiiEntitiesCommandInput, DetectPiiEntitiesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
