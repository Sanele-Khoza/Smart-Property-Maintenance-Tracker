...
declare const DetectSentimentCommand_base: {
    new (input: DetectSentimentCommandInput): import("@smithy/core/client").CommandImpl<DetectSentimentCommandInput, DetectSentimentCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectSentimentCommandInput): import("@smithy/core/client").CommandImpl<DetectSentimentCommandInput, DetectSentimentCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
