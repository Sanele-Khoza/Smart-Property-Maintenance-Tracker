...
import type { DetectSyntaxRequest, DetectSyntaxResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DetectSyntaxCommand_base: {
    new (input: DetectSyntaxCommandInput): import("@smithy/core/client").CommandImpl<DetectSyntaxCommandInput, DetectSyntaxCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectSyntaxCommandInput): import("@smithy/core/client").CommandImpl<DetectSyntaxCommandInput, DetectSyntaxCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
