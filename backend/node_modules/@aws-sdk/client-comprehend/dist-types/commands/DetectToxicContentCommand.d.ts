...
import type { DetectToxicContentRequest, DetectToxicContentResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DetectToxicContentCommand_base: {
    new (input: DetectToxicContentCommandInput): import("@smithy/core/client").CommandImpl<DetectToxicContentCommandInput, DetectToxicContentCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectToxicContentCommandInput): import("@smithy/core/client").CommandImpl<DetectToxicContentCommandInput, DetectToxicContentCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
