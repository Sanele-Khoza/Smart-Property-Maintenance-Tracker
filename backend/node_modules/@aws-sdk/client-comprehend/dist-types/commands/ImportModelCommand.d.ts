...
declare const ImportModelCommand_base: {
    new (input: ImportModelCommandInput): import("@smithy/core/client").CommandImpl<ImportModelCommandInput, ImportModelCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportModelCommandInput): import("@smithy/core/client").CommandImpl<ImportModelCommandInput, ImportModelCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
