...
declare const ListDocumentClassificationJobsCommand_base: {
    new (input: ListDocumentClassificationJobsCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentClassificationJobsCommandInput, ListDocumentClassificationJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDocumentClassificationJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListDocumentClassificationJobsCommandInput, ListDocumentClassificationJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
