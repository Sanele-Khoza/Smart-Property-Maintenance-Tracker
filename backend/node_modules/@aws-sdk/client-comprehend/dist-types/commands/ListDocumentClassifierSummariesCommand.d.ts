...
import type { ListDocumentClassifierSummariesRequest, ListDocumentClassifierSummariesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListDocumentClassifierSummariesCommand_base: {
    new (input: ListDocumentClassifierSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentClassifierSummariesCommandInput, ListDocumentClassifierSummariesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDocumentClassifierSummariesCommandInput]): import("@smithy/core/client").CommandImpl<ListDocumentClassifierSummariesCommandInput, ListDocumentClassifierSummariesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
