...
declare const ListDocumentClassifiersCommand_base: {
    new (input: ListDocumentClassifiersCommandInput): import("@smithy/core/client").CommandImpl<ListDocumentClassifiersCommandInput, ListDocumentClassifiersCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDocumentClassifiersCommandInput]): import("@smithy/core/client").CommandImpl<ListDocumentClassifiersCommandInput, ListDocumentClassifiersCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
