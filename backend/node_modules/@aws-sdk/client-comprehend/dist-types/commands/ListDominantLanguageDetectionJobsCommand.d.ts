...
import type { ListDominantLanguageDetectionJobsRequest, ListDominantLanguageDetectionJobsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListDominantLanguageDetectionJobsCommand_base: {
    new (input: ListDominantLanguageDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListDominantLanguageDetectionJobsCommandInput, ListDominantLanguageDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDominantLanguageDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListDominantLanguageDetectionJobsCommandInput, ListDominantLanguageDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
