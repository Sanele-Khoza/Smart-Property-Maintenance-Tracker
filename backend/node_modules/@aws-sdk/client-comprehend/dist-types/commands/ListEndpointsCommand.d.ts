...
import type { ListEndpointsRequest, ListEndpointsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListEndpointsCommand_base: {
    new (input: ListEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListEndpointsCommandInput, ListEndpointsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<ListEndpointsCommandInput, ListEndpointsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
