...
declare const ListEntitiesDetectionJobsCommand_base: {
    new (input: ListEntitiesDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListEntitiesDetectionJobsCommandInput, ListEntitiesDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEntitiesDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListEntitiesDetectionJobsCommandInput, ListEntitiesDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
