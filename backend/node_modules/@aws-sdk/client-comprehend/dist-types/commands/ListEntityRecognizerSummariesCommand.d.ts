...
declare const ListEntityRecognizerSummariesCommand_base: {
    new (input: ListEntityRecognizerSummariesCommandInput): import("@smithy/core/client").CommandImpl<ListEntityRecognizerSummariesCommandInput, ListEntityRecognizerSummariesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEntityRecognizerSummariesCommandInput]): import("@smithy/core/client").CommandImpl<ListEntityRecognizerSummariesCommandInput, ListEntityRecognizerSummariesCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
