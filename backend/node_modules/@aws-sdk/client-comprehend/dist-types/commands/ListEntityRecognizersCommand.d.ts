...
import type { ListEntityRecognizersRequest, ListEntityRecognizersResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListEntityRecognizersCommand_base: {
    new (input: ListEntityRecognizersCommandInput): import("@smithy/core/client").CommandImpl<ListEntityRecognizersCommandInput, ListEntityRecognizersCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEntityRecognizersCommandInput]): import("@smithy/core/client").CommandImpl<ListEntityRecognizersCommandInput, ListEntityRecognizersCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
