...
import type { ListEventsDetectionJobsRequest, ListEventsDetectionJobsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListEventsDetectionJobsCommand_base: {
    new (input: ListEventsDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListEventsDetectionJobsCommandInput, ListEventsDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEventsDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListEventsDetectionJobsCommandInput, ListEventsDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
