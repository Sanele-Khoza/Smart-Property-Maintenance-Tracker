...
declare const ListFlywheelIterationHistoryCommand_base: {
    new (input: ListFlywheelIterationHistoryCommandInput): import("@smithy/core/client").CommandImpl<ListFlywheelIterationHistoryCommandInput, ListFlywheelIterationHistoryCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListFlywheelIterationHistoryCommandInput): import("@smithy/core/client").CommandImpl<ListFlywheelIterationHistoryCommandInput, ListFlywheelIterationHistoryCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
