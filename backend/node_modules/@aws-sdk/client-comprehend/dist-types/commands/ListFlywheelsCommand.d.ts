...
declare const ListFlywheelsCommand_base: {
    new (input: ListFlywheelsCommandInput): import("@smithy/core/client").CommandImpl<ListFlywheelsCommandInput, ListFlywheelsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFlywheelsCommandInput]): import("@smithy/core/client").CommandImpl<ListFlywheelsCommandInput, ListFlywheelsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
