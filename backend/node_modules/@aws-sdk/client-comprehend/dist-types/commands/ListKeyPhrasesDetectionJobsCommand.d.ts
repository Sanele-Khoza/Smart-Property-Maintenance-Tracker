...
declare const ListKeyPhrasesDetectionJobsCommand_base: {
    new (input: ListKeyPhrasesDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListKeyPhrasesDetectionJobsCommandInput, ListKeyPhrasesDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListKeyPhrasesDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListKeyPhrasesDetectionJobsCommandInput, ListKeyPhrasesDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
