...
declare const ListPiiEntitiesDetectionJobsCommand_base: {
    new (input: ListPiiEntitiesDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListPiiEntitiesDetectionJobsCommandInput, ListPiiEntitiesDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPiiEntitiesDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListPiiEntitiesDetectionJobsCommandInput, ListPiiEntitiesDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
