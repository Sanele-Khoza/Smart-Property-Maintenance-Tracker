...
declare const ListSentimentDetectionJobsCommand_base: {
    new (input: ListSentimentDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListSentimentDetectionJobsCommandInput, ListSentimentDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSentimentDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListSentimentDetectionJobsCommandInput, ListSentimentDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
