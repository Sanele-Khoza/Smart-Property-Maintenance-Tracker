...
import type { ListTargetedSentimentDetectionJobsRequest, ListTargetedSentimentDetectionJobsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListTargetedSentimentDetectionJobsCommand_base: {
    new (input: ListTargetedSentimentDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListTargetedSentimentDetectionJobsCommandInput, ListTargetedSentimentDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTargetedSentimentDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListTargetedSentimentDetectionJobsCommandInput, ListTargetedSentimentDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
