...
import type { ListTopicsDetectionJobsRequest, ListTopicsDetectionJobsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListTopicsDetectionJobsCommand_base: {
    new (input: ListTopicsDetectionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListTopicsDetectionJobsCommandInput, ListTopicsDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTopicsDetectionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListTopicsDetectionJobsCommandInput, ListTopicsDetectionJobsCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
