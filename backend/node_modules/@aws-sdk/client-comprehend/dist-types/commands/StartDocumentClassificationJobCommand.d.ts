...
declare const StartDocumentClassificationJobCommand_base: {
    new (input: StartDocumentClassificationJobCommandInput): import("@smithy/core/client").CommandImpl<StartDocumentClassificationJobCommandInput, StartDocumentClassificationJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDocumentClassificationJobCommandInput): import("@smithy/core/client").CommandImpl<StartDocumentClassificationJobCommandInput, StartDocumentClassificationJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
