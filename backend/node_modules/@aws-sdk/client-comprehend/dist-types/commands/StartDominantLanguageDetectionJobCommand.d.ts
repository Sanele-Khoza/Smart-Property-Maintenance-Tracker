...
import type { StartDominantLanguageDetectionJobRequest, StartDominantLanguageDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartDominantLanguageDetectionJobCommand_base: {
    new (input: StartDominantLanguageDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartDominantLanguageDetectionJobCommandInput, StartDominantLanguageDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDominantLanguageDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartDominantLanguageDetectionJobCommandInput, StartDominantLanguageDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
