...
declare const StartEntitiesDetectionJobCommand_base: {
    new (input: StartEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartEntitiesDetectionJobCommandInput, StartEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartEntitiesDetectionJobCommandInput, StartEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
