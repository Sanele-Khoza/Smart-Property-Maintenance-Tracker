...
import type { StartEventsDetectionJobRequest, StartEventsDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartEventsDetectionJobCommand_base: {
    new (input: StartEventsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartEventsDetectionJobCommandInput, StartEventsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartEventsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartEventsDetectionJobCommandInput, StartEventsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
