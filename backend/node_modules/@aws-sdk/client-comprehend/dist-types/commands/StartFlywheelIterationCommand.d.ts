...
import type { StartFlywheelIterationRequest, StartFlywheelIterationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartFlywheelIterationCommand_base: {
    new (input: StartFlywheelIterationCommandInput): import("@smithy/core/client").CommandImpl<StartFlywheelIterationCommandInput, StartFlywheelIterationCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartFlywheelIterationCommandInput): import("@smithy/core/client").CommandImpl<StartFlywheelIterationCommandInput, StartFlywheelIterationCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
