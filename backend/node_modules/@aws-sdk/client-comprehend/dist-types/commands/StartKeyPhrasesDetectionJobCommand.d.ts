...
declare const StartKeyPhrasesDetectionJobCommand_base: {
    new (input: StartKeyPhrasesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartKeyPhrasesDetectionJobCommandInput, StartKeyPhrasesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartKeyPhrasesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartKeyPhrasesDetectionJobCommandInput, StartKeyPhrasesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
