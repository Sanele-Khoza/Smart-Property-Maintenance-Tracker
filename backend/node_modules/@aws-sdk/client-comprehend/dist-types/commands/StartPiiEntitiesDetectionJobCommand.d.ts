...
declare const StartPiiEntitiesDetectionJobCommand_base: {
    new (input: StartPiiEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartPiiEntitiesDetectionJobCommandInput, StartPiiEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartPiiEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartPiiEntitiesDetectionJobCommandInput, StartPiiEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
