...
import type { StartSentimentDetectionJobRequest, StartSentimentDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartSentimentDetectionJobCommand_base: {
    new (input: StartSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartSentimentDetectionJobCommandInput, StartSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartSentimentDetectionJobCommandInput, StartSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
