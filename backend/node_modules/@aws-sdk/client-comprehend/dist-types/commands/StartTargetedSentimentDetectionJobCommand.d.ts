...
import type { StartTargetedSentimentDetectionJobRequest, StartTargetedSentimentDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartTargetedSentimentDetectionJobCommand_base: {
    new (input: StartTargetedSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartTargetedSentimentDetectionJobCommandInput, StartTargetedSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartTargetedSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartTargetedSentimentDetectionJobCommandInput, StartTargetedSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
