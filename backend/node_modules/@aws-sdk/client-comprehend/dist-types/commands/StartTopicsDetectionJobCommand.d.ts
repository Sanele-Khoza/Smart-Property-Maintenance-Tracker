...
import type { StartTopicsDetectionJobRequest, StartTopicsDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartTopicsDetectionJobCommand_base: {
    new (input: StartTopicsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartTopicsDetectionJobCommandInput, StartTopicsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartTopicsDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StartTopicsDetectionJobCommandInput, StartTopicsDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
