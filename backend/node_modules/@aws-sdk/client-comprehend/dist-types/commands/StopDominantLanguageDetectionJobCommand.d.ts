...
import type { StopDominantLanguageDetectionJobRequest, StopDominantLanguageDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StopDominantLanguageDetectionJobCommand_base: {
    new (input: StopDominantLanguageDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopDominantLanguageDetectionJobCommandInput, StopDominantLanguageDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopDominantLanguageDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopDominantLanguageDetectionJobCommandInput, StopDominantLanguageDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
