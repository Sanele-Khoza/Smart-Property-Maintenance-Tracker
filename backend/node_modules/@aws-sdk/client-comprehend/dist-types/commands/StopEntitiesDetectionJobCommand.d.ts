...
import type { StopEntitiesDetectionJobRequest, StopEntitiesDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StopEntitiesDetectionJobCommand_base: {
    new (input: StopEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopEntitiesDetectionJobCommandInput, StopEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopEntitiesDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopEntitiesDetectionJobCommandInput, StopEntitiesDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
