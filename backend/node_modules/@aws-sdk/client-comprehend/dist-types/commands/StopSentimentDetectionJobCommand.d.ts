...
import type { StopSentimentDetectionJobRequest, StopSentimentDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StopSentimentDetectionJobCommand_base: {
    new (input: StopSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopSentimentDetectionJobCommandInput, StopSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopSentimentDetectionJobCommandInput, StopSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
