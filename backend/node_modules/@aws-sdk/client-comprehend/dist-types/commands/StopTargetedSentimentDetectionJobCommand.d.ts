...
import type { StopTargetedSentimentDetectionJobRequest, StopTargetedSentimentDetectionJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StopTargetedSentimentDetectionJobCommand_base: {
    new (input: StopTargetedSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopTargetedSentimentDetectionJobCommandInput, StopTargetedSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopTargetedSentimentDetectionJobCommandInput): import("@smithy/core/client").CommandImpl<StopTargetedSentimentDetectionJobCommandInput, StopTargetedSentimentDetectionJobCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
