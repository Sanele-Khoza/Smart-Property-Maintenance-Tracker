...
declare const StopTrainingDocumentClassifierCommand_base: {
    new (input: StopTrainingDocumentClassifierCommandInput): import("@smithy/core/client").CommandImpl<StopTrainingDocumentClassifierCommandInput, StopTrainingDocumentClassifierCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopTrainingDocumentClassifierCommandInput): import("@smithy/core/client").CommandImpl<StopTrainingDocumentClassifierCommandInput, StopTrainingDocumentClassifierCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
