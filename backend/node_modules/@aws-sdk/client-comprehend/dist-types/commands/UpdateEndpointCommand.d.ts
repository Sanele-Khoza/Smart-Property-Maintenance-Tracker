...
declare const UpdateEndpointCommand_base: {
    new (input: UpdateEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateEndpointCommandInput, UpdateEndpointCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateEndpointCommandInput, UpdateEndpointCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
