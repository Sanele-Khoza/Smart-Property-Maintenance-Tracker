...
declare const UpdateFlywheelCommand_base: {
    new (input: UpdateFlywheelCommandInput): import("@smithy/core/client").CommandImpl<UpdateFlywheelCommandInput, UpdateFlywheelCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFlywheelCommandInput): import("@smithy/core/client").CommandImpl<UpdateFlywheelCommandInput, UpdateFlywheelCommandOutput, import("..").ComprehendClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
