...
class RekognitionClient extends Client {
    config;
...
const paginateDescribeProjectVersions = createPaginator(RekognitionClient, DescribeProjectVersionsCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetCelebrityRecognition = createPaginator(RekognitionClient, GetCelebrityRecognitionCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetContentModeration = createPaginator(RekognitionClient, GetContentModerationCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetFaceDetection = createPaginator(RekognitionClient, GetFaceDetectionCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetFaceSearch = createPaginator(RekognitionClient, GetFaceSearchCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetLabelDetection = createPaginator(RekognitionClient, GetLabelDetectionCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetPersonTracking = createPaginator(RekognitionClient, GetPersonTrackingCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetSegmentDetection = createPaginator(RekognitionClient, GetSegmentDetectionCommand, "NextToken", "NextToken", "MaxResults");

const paginateGetTextDetection = createPaginator(RekognitionClient, GetTextDetectionCommand, "NextToken", "NextToken", "MaxResults");

const paginateListCollections = createPaginator(RekognitionClient, ListCollectionsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListDatasetEntries = createPaginator(RekognitionClient, ListDatasetEntriesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListDatasetLabels = createPaginator(RekognitionClient, ListDatasetLabelsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListFaces = createPaginator(RekognitionClient, ListFacesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMediaAnalysisJobs = createPaginator(RekognitionClient, ListMediaAnalysisJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListProjectPolicies = createPaginator(RekognitionClient, ListProjectPoliciesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListStreamProcessors = createPaginator(RekognitionClient, ListStreamProcessorsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListUsers = createPaginator(RekognitionClient, ListUsersCommand, "NextToken", "NextToken", "MaxResults");
