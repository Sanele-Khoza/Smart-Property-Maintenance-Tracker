...
const DEMO_USER_IDS = [
  'a0000000-0000-0000-0000-000000000002',  // John (Manager)
  'a0000000-0000-0000-0000-000000000003',  // Sarah (Tenant)
  'a0000000-0000-0000-0000-000000000004',  // Mike (Tenant)
  'a0000000-0000-0000-0000-000000000005',  // Jane (Tenant)
  'a0000000-0000-0000-0000-000000000006',  // Bob (Provider)
  'a0000000-0000-0000-0000-000000000007',  // Sarah M (Manager)
  'a0000000-0000-0000-0000-000000000008',  // Nomsa (Manager)
  'a0000000-0000-0000-0000-000000000009',  // Linda (Tenant)
  'a0000000-0000-0000-0000-00000000000a',  // Thabo (Tenant)
  'a0000000-0000-0000-0000-00000000000b',  // Zanele (Tenant)
];

const DEMO_SP_IDS = [
  'c0000000-0000-0000-0000-000000000001',  // Bob
  'c0000000-0000-0000-0000-000000000002',  // Alice
  'c0000000-0000-0000-0000-000000000003',  // Tom
  'c0000000-0000-0000-0000-000000000004',  // Lisa
  'c0000000-0000-0000-0000-000000000005',  // David
  'c0000000-0000-0000-0000-000000000006',  // Henry
  'c0000000-0000-0000-0000-000000000007',  // Grace
  'c0000000-0000-0000-0000-000000000008',  // Ivy
];
