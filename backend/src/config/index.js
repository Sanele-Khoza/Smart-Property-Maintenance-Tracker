...
const config = {
  ...
  cors: {
    origin: process.env.CORS_ORIGINS || process.env.CORS_ORIGIN || 'http://localhost:5173',
  },
  jwt: {
  ...
  ai: {
    textConfidenceThreshold: parseFloat(process.env.AI_TEXT_CONFIDENCE_THRESHOLD) || 0.60,
    emergencyVisualThreshold: parseFloat(process.env.AI_EMERGENCY_VISUAL_THRESHOLD) || 0.70,
  },
  aws: {
    ...
    s3: {
      ...
      presignedUrlTtlImages: parseInt(process.env.S3_PRESIGNED_URL_TTL_IMAGES_SECONDS, 10) || 900,
      presignedUrlTtlReports: parseInt(process.env.S3_PRESIGNED_URL_TTL_REPORTS_SECONDS, 10) || 86400,
    },
    sns: {
