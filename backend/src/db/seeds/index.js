...
import { ALL_PERMISSIONS, RBAC_MATRIX } from '../../shared/constants/permissions.js';
...
async function seed(query) {
  ...
  const users = [
    ...
    { id: ID.manager, name: 'John',          surname: 'Manager',   email: 'manager@spmt.com',  phone: '0115550101', hash: hash('manager123'),  role: 'PROPERTY_MANAGER',  status: 'ACTIVE', approved: true },
    { id: ID.sarah,   name: 'Sarah',         surname: 'Tenant',    email: 'sarah@email.com',   phone: '0115550102', hash: hash('tenant123'),   role: 'TENANT',            status: 'ACTIVE', approved: true },
    { id: ID.mike,    name: 'Mike',          surname: 'Tenant',    email: 'mike@email.com',    phone: '0115550103', hash: hash('tenant123'),   role: 'TENANT',            status: 'ACTIVE', approved: true },
    { id: ID.jane,    name: 'Jane',          surname: 'Tenant',    email: 'jane@email.com',    phone: '0115550104', hash: hash('tenant123'),   role: 'TENANT',            status: 'ACTIVE', approved: true },
    { id: ID.bob,     name: 'Bob Technician', surname: 'Tech',     email: 'bob.tech@email.com', phone: '0115550105', hash: hash('provider123'), role: 'SERVICE_PROVIDER',  status: 'ACTIVE', approved: true },
  ];
  ...
  /* ── 3. service_providers ── */
  const providers = [
    { id: ID.bobTech, name: 'Bob The Builder', companyName: "Bob's Repairs",  email: 'bob.tech@email.com',  phone: '0115550105', specialisations: ['Plumbing', 'Electrical'],      rating: 4.5, workload: 2, status: 'AVAILABLE' },
    { id: ID.alice,   name: 'Alice Mkhize',    companyName: 'Alice Electric',  email: 'alice@email.com',     phone: '0115550106', specialisations: ['Electrical', 'HVAC'],          rating: 4.8, workload: 1, status: 'AVAILABLE' },
    { id: ID.tom,     name: 'Tom Ndlovu',       companyName: "Tom's Painters",  email: 'tom@email.com',       phone: '0115550107', specialisations: ['Painting', 'Carpentry'],        rating: 4.2, workload: 3, status: 'ON_CALL' },
    { id: ID.lisa,    name: 'Lisa Chen',        companyName: 'Lisa Plumbing Co', email: 'lisa@email.com',    phone: '0115550108', specialisations: ['Plumbing'],                    rating: 4.9, workload: 0, status: 'AVAILABLE' },
    { id: ID.david,   name: 'David Smith',      companyName: 'Smith Repairs',   email: 'david@email.com',     phone: '0115550109', specialisations: ['Carpentry', 'Plumbing'],       rating: 4.0, workload: 4, status: 'OFF_DUTY' },
  ];
  ...
  const units = [
    ...
    { id: UNIT[3], propertyId: ID.riverside, unitNumber: 'A1',  floor: '1', type: 'Studio',  bedrooms: 0, bathrooms: 1, sizeSqm: 30,  status: 'Occupied', occupantId: ID.jane },
    { id: UNIT[4], propertyId: ID.riverside, unitNumber: 'B2',  floor: '2', type: '1-Bed',  bedrooms: 1, bathrooms: 1, sizeSqm: 42,  status: 'Vacant',   occupantId: null },
    { id: UNIT[5], propertyId: ID.greenwood, unitNumber: 'GA-01', floor: '0', type: '3-Bed', bedrooms: 3, bathrooms: 2, sizeSqm: 120, status: 'Occupied', occupantId: null },
    { id: UNIT[6], propertyId: ID.cbd,       unitNumber: 'PH-A',  floor: '5', type: 'Office', bedrooms: 0, bathrooms: 1, sizeSqm: 85,  status: 'Vacant',   occupantId: null },
    { id: UNIT[7], propertyId: ID.lakeside,  unitNumber: 'LV-01', floor: '1', type: '2-Bed', bedrooms: 2, bathrooms: 2, sizeSqm: 75,  status: 'Vacant',   occupantId: null },
    { id: UNIT[8], propertyId: ID.lakeside,  unitNumber: 'LV-02', floor: '1', type: '1-Bed', bedrooms: 1, bathrooms: 1, sizeSqm: 40,  status: 'Vacant',   occupantId: null },
    { id: UNIT[9], propertyId: ID.riverside, unitNumber: 'A2',  floor: '1', type: 'Studio',  bedrooms: 0, bathrooms: 1, sizeSqm: 32,  status: 'Vacant',   occupantId: null },
  ];
  ...
  /* ── 5. tickets ── */
  const tickets = [
    { id: TICKET[0], unitId: UNIT[0], tenantId: ID.sarah, category: 'Plumbing',     title: 'Leaking faucet in kitchen',               description: 'Kitchen faucet has been leaking for two days. Water pooling under sink.', priority: 'HIGH',   status: 'In Progress', assignedTo: ID.bobTech, source: 'tenant_portal', dueDate: new Date('2026-03-18T08:00:00Z') },
    { id: TICKET[1], unitId: UNIT[3], tenantId: ID.jane,  category: 'Electrical',   title: 'Power outlet not working',                 description: 'Main power outlet in living room not working.',                          priority: 'MEDIUM', status: 'Assigned',     assignedTo: ID.alice,   source: 'tenant_portal', dueDate: new Date('2026-03-25T09:00:00Z') },
    { id: TICKET[2], unitId: UNIT[0], tenantId: ID.sarah, category: 'Painting',     title: 'Wall paint peeling in bedroom',             description: 'Paint on north wall bubbling and peeling. Needs stripping and repaint.',  priority: 'LOW',    status: 'Open',         assignedTo: null,                source: 'tenant_portal', dueDate: new Date('2026-04-15T14:00:00Z') },
    { id: TICKET[3], unitId: UNIT[5], tenantId: null,      category: 'HVAC',         title: 'Air conditioning not cooling',              description: 'AC unit running but not cooling space. Filter seems clean.',               priority: 'HIGH',   status: 'Open',         assignedTo: null,                source: 'phone',        dueDate: new Date('2026-04-08T11:00:00Z') },
    { id: TICKET[4], unitId: UNIT[0], tenantId: ID.sarah, category: 'Plumbing',     title: 'Toilet running constantly',                 description: 'Toilet continues to run after flushing. Needs new flapper valve.',         priority: 'MEDIUM', status: 'Completed',    assignedTo: ID.bobTech, source: 'tenant_portal', dueDate: new Date('2026-03-13T07:00:00Z') },
    { id: TICKET[5], unitId: UNIT[7], tenantId: null,      category: 'Plumbing',     title: 'Preventive maintenance - water heater',     description: 'Annual water heater inspection for unit LV-01.',                           priority: 'LOW',    status: 'Open',         assignedTo: ID.lisa,    source: 'system',       dueDate: new Date('2026-04-20T08:00:00Z') },
    { id: TICKET[6], unitId: UNIT[1], tenantId: ID.mike,  category: 'Electrical',   title: 'Light fixture broken',                      description: 'Ceiling light fixture in hallway dangling. Needs immediate attention.',    priority: 'MEDIUM', status: 'Open',         assignedTo: null,                source: 'tenant_portal', dueDate: new Date('2026-04-17T16:00:00Z') },
    { id: TICKET[7], unitId: UNIT[6], tenantId: null,      category: 'Carpentry',    title: 'Office door jammed',                        description: 'Main entrance door to office PH-A is stuck. Cannot open or close.',        priority: 'HIGH',   status: 'Open',         assignedTo: null,                source: 'email',        dueDate: new Date('2026-04-16T09:00:00Z') },
  ];
  ...
  await query(
    ...
    [NOTIF[0], ID.sarah, NOTIF[1], ID.admin, NOTIF[2], ID.manager, NOTIF[3], ID.bob]
  );
