...
router.put('/:id/assign', authenticate, authorize(Roles.SYSTEM_ADMIN, Roles.PROPERTY_MANAGER), auditLog('UNIT_ASSIGNED', req => ({ type: 'unit', id: req.params.id })), ctrl.assign);
