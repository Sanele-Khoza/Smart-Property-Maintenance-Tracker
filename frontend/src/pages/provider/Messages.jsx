...
import { FaBell, FaEnvelope, FaMobileAlt, FaDesktop, FaCheckCircle, FaExclamationTriangle, FaClock, FaTimesCircle, FaBolt } from 'react-icons/fa';
...
const Messages = () => {
  ...
  const myNotifs = allNotifs.filter(n => n.recipient === providerEmail);
  ...
  return (
    <>
      <div className="welcome-banner"><h2><FaBell /> Messages</h2><p>Notification history for your account.</p></div>
      <div className="card">
