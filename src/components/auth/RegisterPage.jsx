        ...
        {verificationToken && (
          <div style={{
            ...
            <div style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--ink)', marginTop: 6 }}>
              Account created! In production an email would be sent to {registeredEmail}. Your verification token is:
            </div>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: 16, color: 'var(--amber)', fontWeight: 700, marginTop: 8 }}>
              {verificationToken}
            </div>
            <div style={{ fontFamily: 'var(--font-body)', fontSize: 11, color: 'var(--text-mid)', marginTop: 6 }}>
              Click 'Verify Email' below or enter this token on the verification page.
            </div>
            <button
