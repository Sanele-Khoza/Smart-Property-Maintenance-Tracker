...
export const createTicket = async (unitId, title, description, priority, images, createdById, createdByName, aiFields, forceSubmit = false) => {
  try {
    const result = await api('/tickets', {
      ...
      body: {
        ...
        description,
        priority: aiFields?.overridePriority || priority || 'MEDIUM',
